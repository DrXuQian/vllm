...
def ensure_kvfloat13_decode_op() -> bool:
    global _LOADED
    if hasattr(torch.ops, "_C_cache_ops") and hasattr(
        ...
        return True
    if _LOADED:
        return hasattr(torch.ops._C_cache_ops, "decode_kvfloat13_blocks")
    ...
    with _LOAD_LOCK:
        ...
        source = Path(__file__).with_name("kvfloat13_decode_ext.cu")
        build_root = Path(
            os.environ.get(
        ...
        build_dir = build_root / "kvfloat13_decode"
